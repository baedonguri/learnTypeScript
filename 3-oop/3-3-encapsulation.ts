{
    /**
     * 객체지향적으로 커피기계 만들기
     * encapsulation : 캡슐화는 클래스를 만들 때, 외부 혹은 내부에서 접근할 수 있는 요소들을 정의하는 것
     */
    type CoffeeCup = {
      shots: number;
      hasMilk: boolean;
    ...
    class CoffeeMaker {
      ...
      private constructor(coffeeBeans: number) { // constructor는 class를 이용하여 object를 만들 때, 항상 처음 호출되는 함수
